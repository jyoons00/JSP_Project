...
<body>
	...
	<div id="container">
			...
			<div id="SP_boardPageChk">
                ...
                -->
														...
														<div class="fr-view fr-view-article">
															<p>
																<a
																	...
																	src="/web/upload/magazine/1230_lucanus/howtouse_1200_03.jpg"
																	class="fr-fic fr-dib"></a><br>
															</p>
															<p>
																<img
																	src="/web/upload/magazine/1230_lucanus/howtouse_1200_04.jpg"
																	class="fr-fic fr-dib">
															</p>
															<p>
																<img
																	src="/web/upload/magazine/1230_lucanus/howtouse_1200_05.jpg"
																	class="fr-fic fr-dib">
															</p>
															<img
																src="/web/upload/magazine/1230_lucanus/howtouse_1200_06.jpg"
																class="fr-fic fr-dib">
														</div>
													</div>
												</td>
								...
								<div class="SP_submitBtn_wrap SP_submitBoardBtn_wrap ">
									...
									</span> <span class="SP_submitBtn_right"> <a href="#none"
					...
					<div
						...
						<ul>
							<li class="prev "><span>이전글</span><a
								href="/article/how-to/13/153009/">젤네일팁 사용편</a></li>
							<li class="next "><span>다음글</span><a
								href="/article/how-to/13/118207/">너리싱 네일 오일 사용법</a></li>
						</ul>
					</div>
        ...
        -->
					<ul class="items common_items">
						<li id="anchorBoxId_776" data-prd="776" class="on xans-record-">
							<div class="container" data-prd-no="776">
								<dl>
									<a
									...
									<div class="base_img">
										...
										<div class="thumb">
											<img loading="lazy"
												ec-data-src="//www.ohora.kr/web/product/medium/202206/b6fe4302016acc84bfbf25e779d307f2.jpg"
												alt="" class="thumb_img" width="800" height="800"
												src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR4nGP6zwAAAgcBApocMXEAAAAASUVORK5CYII="><img
												loading="lazy"
												data-src="//www.ohora.kr/web/product/big/202206/14b40534a2d41f77034f32ff583e7bed.jpg"
												class="hover_img" width="800" height="800">
										</div>
										<!-- 추가 이미지 가져오기 위한 영역 -->
										<div class="add_img"
											data-add1="//www.ohora.kr/web/product/extra/big/202206/83830031b6d5e8d0a838a7faa421d86b.jpg"
											data-add2="//www.ohora.kr/web/product/extra/big/202206/6d3be936ed0fbd159ada29b141b6fb9f.jpg"
											data-add3="//www.ohora.kr/web/product/extra/big/202206/9d484e5430f9b13d108fb6e8413c97f7.jpg"
											data-id="eListPrdImage776_1"></div>
										<!-- 추가 이미지 가져오기 위한 영역 -->
										<span class="wishIcon"><img
											...
											productno="776" categoryno="120" icon_status="off"
										...
										<!------------------------------- @@ 품절일 시 on -------------------------------------------------------->
										<span class="soldout_img"><a
											href="/product/detail.html?product_no=776&amp;cate_no=120&amp;display_group=1"><span>coming<br>soon
											</span></a></span>
										<!------------------------------- @@ 품절일 시 on -------------------------------------------------------->
									</div>
									<div class="base_mask">
										...
										<dd class="price_container">
											...
											<p class="price  ">
												14,800 <span class="displaynone"></span>
											</p>
											<p class="sale_price displaynone"></p>
											<div class="dcPercent"></div>
										</dd>
										<dd class="icons">
											<span class="soldout"></span> <span class="new"></span> <span
												class="recommend"></span> <span class="benefit"></span>
										</dd>
										<dd class="prdRegister_date">Mon, 01 Feb 2021 16:14:44
											+0900</dd>
										<!-- 상품 정보 하단 영역 -->
												...
												<div class="crema_wrap">
													<p class="rv_value">
														<span class="crema-product-reviews-score crema-applied"
															...
															data-hide-if-zero="1" data-install-method="hardcoded"
    ...
    <use xlink:href="#star-full"></use>
										...
										<div class="rv_icon">
											<a
												href="/product/detail.html?product_no=776&amp;cate_no=120&amp;display_group=1&amp;smslay=category&amp;smsps=prd#SMS_detailTab_focus">
											...
											<div class="xans-element- xans-product xans-product-listitem">
												<div class=" xans-record-">
													<strong class="title displaynone"><span
														...
														:</strong><strong class="item_content"><span
														...
														style="text-decoration: line-through;"> </span></strong>
												</div>
												<div class=" xans-record-">
													<strong class="title displaynone"><span
														style="font-size: 12px; color: #555555;">사용후기</span> :</strong><strong
														class="item_content"><span
														style="font-size: 12px; color: #555555;">234</span></strong>
												</div>
												<div class=" xans-record-">
													<strong class="title displaynone"> :</strong><strong
														class="item_content"></strong>
												</div>
												<div class=" xans-record-">
													<strong class="title displaynone"><span
														style="font-size: 12px; color: #555555;">해시태그</span> :</strong><strong
														class="item_content"><span
														style="font-size: 12px; color: #555555;">#네일 #아트
															#버건디 #레드 #마블 #가을네일</span></strong>
												</div>
												<div class=" xans-record-">
													<strong class="title displaynone"><span
														style="font-size: 12px; color: #555555;">상품필터값</span> :</strong><strong
														class="item_content"><span
														style="font-size: 12px; color: #555555;">마블,데일리</span></strong>
												</div>
											</div>
										</div>
										<!-- @@ 상품 정보 호출용 -->
